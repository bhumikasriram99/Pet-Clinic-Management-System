 ...
 * @author CR-2
 */
public class frmcatsurgerydetails_delete extends javax.swing.JFrame {

    /**
     * Creates new form frmcatsurgerydetails_delete
     */
    public frmcatsurgerydetails_delete() {
        initComponents();
    }
        ...
        {    JOptionPane sc=new JOptionPane();
            ...
            else
            {
                ...
                if(result==sc.YES_OPTION)
                {
                    ...
                    String sql="delete from catsurgerydetails where surgeryid='"+id+"'";
                    st.executeQuery(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmcatsurgerydetails_delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmcatsurgerydetails_delete().setVisible(true);
            }
        });
    }
