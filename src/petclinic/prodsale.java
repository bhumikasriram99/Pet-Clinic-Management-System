 ...
 * @author CR-2
 */
public class prodsale extends javax.swing.JFrame {

    /** Creates new form prodsale */
    public prodsale() {
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try
        {
            ...
            ResultSet rs1,rs2;
            rs1 = st.executeQuery("select * from prodsale  order by invoicenumber" );
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                String sql = "insert into prodsale values('"+no+"','"+invdate+"','"+supplier+"','"+customer+"','"+product+"',"+quantity+","+rate+","+amount+","+gst+","+tax+","+net+")";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prodsale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
