 ...
 * @author CR-2
 */
public class medsale extends javax.swing.JFrame {

    /**
     * Creates new form medsale
     */
    public medsale() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cmbproduct.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbgst.setEditable(true);
        cmbgst.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "5", "12", "18" }));
        cmbgst.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
       ...
       DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MMM/yyyy");  
        ...
        try
        {
            ...
            ResultSet rs1,rs2;
            rs1 = st.executeQuery("select * from medsale  order by invoicenumber" );
             Statement st1=con.createStatement();
            rs2 =st1.executeQuery("select * from medicine");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                String sql = "insert into medsale values('"+no+"','"+invdate+"','"+supplier+"','"+customer+"','"+product+"',"+quantity+","+rate+","+amount+","+gst+","+tax+","+net+")";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(medsale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
