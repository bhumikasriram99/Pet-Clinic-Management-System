 ...
 * @author CR-2
 */
public class frmdogsurgery_delete extends javax.swing.JFrame {

    /**
     * Creates new form frmdogsurgery_delete
     */
    public frmdogsurgery_delete() {
        initComponents();
    }
 ...
 try
        ...
        {    JOptionPane sc=new JOptionPane();
            ...
            else
            {
                ...
                if(result==sc.YES_OPTION)
                {
                    Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","bhumika","bhumika");
                    Statement st=con.createStatement();
                    String sql="delete from dogsurgery where surgeryid='"+id+"'";
                    st.executeQuery(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmdogsurgery_delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmdogsurgery_delete().setVisible(true);
            }
        });
    }
