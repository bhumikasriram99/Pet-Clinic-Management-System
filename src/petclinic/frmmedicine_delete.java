 ...
 * @author CR-2
 */
public class frmmedicine_delete extends javax.swing.JFrame {

    /**
     * Creates new form frmmedicine_delete
     */
    public frmmedicine_delete() {
        initComponents();
    }
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        try
        {
            ...
            if(result == sc.YES_OPTION)
            {
                ...
                String sql="delete from medicine where productid='"+pid+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmedicine_delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmedicine_delete().setVisible(true);
            }
        });
    }
