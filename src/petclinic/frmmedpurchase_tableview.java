 ...
 * @author CR-2
 */
public class frmmedpurchase_tableview extends javax.swing.JFrame {

    /**
     * Creates new form frmmedpurchase_tableview
     */
    public frmmedpurchase_tableview() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("VIEW MEDICINE PURCHASE DETAILS");
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from medpurchase" );
    ...
    private void btnshowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnshowActionPerformed
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from medpurchase where invoicenumber='"+pid+"'" );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmedpurchase_tableview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmedpurchase_tableview().setVisible(true);
            }
        });
    }
