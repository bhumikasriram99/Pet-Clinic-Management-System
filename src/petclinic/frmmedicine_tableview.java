 ...
 * @author CR-2
 */
public class frmmedicine_tableview extends javax.swing.JFrame {

    /**
     * Creates new form frmmedicine_tableview
     */
    public frmmedicine_tableview() {
        initComponents();
    }
    ...
    private void btnshowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnshowActionPerformed
        // TODO add your handling code here:
        String[]columnnames={"Product Id","Product Name","Comapny Name","Manufacture Date","Expiry Date","Dosage"};
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from medicine where productid='"+pid+"'" );
            ...
            while(rs.next())
            {
                ...
                model.addRow(new Object[]{pid,pname,cname,mdate,edate,dosage});
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmedicine_tableview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmedicine_tableview().setVisible(true);
            }
        });
    }
