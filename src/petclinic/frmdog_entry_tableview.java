 ...
 * @author CR-2
 */
public class frmdog_entry_tableview extends javax.swing.JFrame {

    /**
     * Creates new form frmdog_entry_tableview
     */
    public frmdog_entry_tableview() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VIEW DOG DETAILS");
    ...
    private void btnshowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnshowActionPerformed
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from dog where patientid='"+pid+"'" );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmdog_entry_tableview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmdog_entry_tableview().setVisible(true);
            }
        });
    }
