 ...
 * @author CR-2
 */
public class frmprodsale_tableview extends javax.swing.JFrame {

    /** Creates new form frmprodsale_tableview */
    public frmprodsale_tableview() {
        initComponents();
    }
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from prodsale" );
    ...
    private void btnshowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnshowActionPerformed
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from prodsale where invoicenumber='"+pid+"'" );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmprodsale_tableview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmprodsale_tableview().setVisible(true);
            }
        });
    }
