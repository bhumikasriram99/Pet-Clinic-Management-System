 ...
 * @author CR-2
 */
public class frmproduct_tableview extends javax.swing.JFrame {

    /**
     * Creates new form frmproduct_tableview
     */
    public frmproduct_tableview() {
        initComponents();
    }
    ...
    private void btnshowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnshowActionPerformed
        // TODO add your handling code here:
        String[]columnnames={"Product Id","Product Name","Comapny Name","Product Category","Manufacture Date","Expiry Date","Units"};
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                units=rs.getString(7);

                model.addRow(new Object[]{pid,pname,cname,pcategory,mdate,edate,units});
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmproduct_tableview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmproduct_tableview().setVisible(true);
            }
        });
    }
