 ...
 * @author CR-2
 */
public class frmmedstock_tableview extends javax.swing.JFrame {

    /**
     * Creates new form frmmedstock_tableview
     */
    public frmmedstock_tableview() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("VIEW MEDICINE STOCK DETAILS");
        ...
        jLabel2.setText("SELECT MEDICINE NAME");
    ...
    private void btnshowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnshowActionPerformed
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from medstock where productname='"+pid+"'" );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmedstock_tableview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmedstock_tableview().setVisible(true);
            }
        });
    }
