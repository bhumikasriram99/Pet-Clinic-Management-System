 ...
 * @author CR-2
 */
public class frmprodpurchase_tableview extends javax.swing.JFrame {

    /**
     * Creates new form frmprodpurchase_tableview
     */
    public frmprodpurchase_tableview() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("VIEW PRODUCT PURCHASE DETAILS");
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from prodpurchase" );
    ...
    private void btnshowallActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnshowallActionPerformed
        // TODO add your handling code here:
        String[]columnnames={"Invoice Number","Invoice Date","Supplier Name","Customer Name","Product Name","Quantity","Rate","Amount","Gst","Tax Amount","Net Amount"};
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                tax=rs.getString(10);
                net=rs.getString(11);
                model.addRow(new Object[]{pid,idate,sname,cname,pname,quantity,rate,amount,gst,tax,net});
            }
    ...
    private void btnshowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnshowActionPerformed
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from prodpurchase where invoicenumber='"+pid+"'" );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmprodpurchase_tableview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmprodpurchase_tableview().setVisible(true);
            }
        });
    }
