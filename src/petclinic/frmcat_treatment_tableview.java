 ...
 * @author CR-2
 */
public class frmcat_treatment_tableview extends javax.swing.JFrame {

    /**
     * Creates new form frmcat_treatment_tableview
     */
    public frmcat_treatment_tableview() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("VIEW CAT TREATMENT DETAILS");
    ...
    private void btnshowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnshowActionPerformed
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from cattreatment where patientid='"+pid+"'" );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmcat_treatment_tableview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmcat_treatment_tableview().setVisible(true);
            }
        });
    }
